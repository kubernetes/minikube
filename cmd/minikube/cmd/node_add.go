...
var nodeAddCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		out.Styled(style.Happy, "Adding node {{.name}} to cluster {{.cluster}}", out.V{"name": name, "cluster": cc.Name})
		...
		out.Styled(style.Ready, "Successfully added {{.name}} to {{.cluster}}!", out.V{"name": name, "cluster": cc.Name})
	},
}
