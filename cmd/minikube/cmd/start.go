...
func hostDriver(existing *config.ClusterConfig, options *run.Options) string {
	if existing == nil {
		return ""
	}
...
func validateSpecifiedDriver(existing *config.ClusterConfig, options *run.Options) {
	if existing == nil {
		return
	}
...
func startNerdctld(options *run.Options) {
