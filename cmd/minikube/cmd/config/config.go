...
var settings = []Setting{
	...
	{
		name:        "host-only-cidr",
		description: "The CIDR to be used for the minikube VM (virtualbox driver only) (default \"192.168.59.1/24\")",
		set:         SetString,
	...
	},
	{
		...
		description: "The Hyper-V virtual switch name. Defaults to first found. (Hyper-V driver only)",
		set:         SetString,
	},
	{
