...
func createTestConfig(t *testing.T) {
	...
	if err = os.MkdirAll(localpath.MakeMiniPath(localpath.MiniPath(), "config"), 0777); err != nil {
		t.Fatalf("error creating temporary directory: %+v", err)
	}

	if err = os.MkdirAll(localpath.MakeMiniPath(localpath.MiniPath(), "profiles"), 0777); err != nil {
