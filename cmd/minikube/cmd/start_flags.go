...
func generateClusterConfig(cmd *cobra.Command, existing *config.ClusterConfig, k8sVersion string, rtime string, drvName string, options *run.Options) (config.ClusterConfig, config.Node, error) {
...
func getNetwork(driverName string, options *run.Options) string {
...
func validateVfkitNetwork(n string, options *run.Options) string {
	if runtime.GOOS != "darwin" {
...
func generateNewConfigFromFlags(cmd *cobra.Command, k8sVersion string, rtime string, drvName string, options *run.Options) config.ClusterConfig {
	var cc config.ClusterConfig
