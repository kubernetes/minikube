...
func DeleteProfiles(profiles []*config.Profile, options *run.Options) []error {
...
func deleteProfileTimeout(profile *config.Profile, options *run.Options) []error {
...
func deleteProfile(ctx context.Context, profile *config.Profile, options *run.Options) error {
...
func unpauseIfNeeded(profile *config.Profile, options *run.Options) error {
