...
integration-vfkit-docker-macos-arm: build-mini-test
	echo ${JOB_NAME}
	curl -X POST "http://boskos.test-pods.svc.cluster.local/release?name=28zmx-sibu3-yy3oc-zmvxf-smpwu-058cv95.us-east-2.ip.aws&dest=dirty&owner=integration-vfkit-docker-macos-arm64-kubetest2"
