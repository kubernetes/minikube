...
integration-prow-docker-docker-linux-x86:
	./hack/prow/minikube_cross_build.sh $(GO_VERSION) linux amd64 true
...
integration-prow-docker-docker-linux-arm:
	./hack/prow/minikube_cross_build.sh $(GO_VERSION) linux arm64 true
...
integration-prow-none-docker-linux-x86: setup-prow-gcp-ssh-keys build-mini-test 
	./hack/prow/minikube_cross_build.sh $(GO_VERSION) linux amd64 false
