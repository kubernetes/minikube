...
func getLatestVersion() (string, error) {
	...
	if err != nil {
		klog.Fatalf("Unable to get Ubuntu focal's latest version: %v", err)
	}
	...
	if err != nil {
		klog.Fatalf("Unable to unmarshall response from Docker Hub: %v", err)
	}
	...
	return "", fmt.Errorf("The response from Docker Hub does not contain a latest focal image\n")
}
