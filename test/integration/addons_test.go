...
func TestAddons(t *testing.T) {
	...
	args := append([]string{"start", "-p", profile, "--wait=false", "--memory=3000", "--alsologtostderr", "--addons=registry", "--addons=metrics-server", "--addons=helm-tiller", "--addons=olm", "--addons=volumesnapshots", "--addons=csi-hostpath-driver", "--addons=gcp-auth"}, StartArgs()...)
