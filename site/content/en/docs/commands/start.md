...
```
      ...
      --base-image string                 The base image to use for docker/podman drivers. Intended for local development. (default "gcr.io/k8s-minikube/kicbase-builds:v0.0.40-1690798047-16970@sha256:a2c00b69b8ef38ad145b9cdc5d4b2071fec69b80c9219ba733ecbfaca25deb41")
      ...
      --kubernetes-version string         The Kubernetes version that the minikube VM will use (ex: v1.2.3, 'stable' for v1.27.3, 'latest' for v1.27.3). Defaults to 'stable'.
