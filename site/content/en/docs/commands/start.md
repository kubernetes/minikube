...
```
  ...
  -h, --help                              help for start
      ...
      --iso-url strings                   Locations to fetch the minikube ISO from. (default [https://storage.googleapis.com/minikube/iso/minikube-v1.12.0-beta.1.iso,https://github.com/kubernetes/minikube/releases/download/v1.12.0-beta.1/minikube-v1.12.0-beta.1.iso,https://kubernetes.oss-cn-hangzhou.aliyuncs.com/minikube/iso/minikube-v1.12.0-beta.1.iso])
