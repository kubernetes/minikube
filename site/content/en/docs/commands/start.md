...
```
      ...
      --base-image string                 The base image to use for docker/podman drivers. Intended for local development. (default "gcr.io/k8s-minikube/kicbase-builds:v0.0.43-1712140117-18565@sha256:b28d1a17d91ecc6f205e9dfab5fe206f0fd0b599acb6b0e0bc8255e28a3213c1")
  ...
  -g, --gpus string                       Allow pods to use your NVIDIA GPUs. Options include: [all,nvidia] (Docker driver with Docker container-runtime only)
      ...
      --kubernetes-version string         The Kubernetes version that the minikube VM will use (ex: v1.2.3, 'stable' for v1.29.3, 'latest' for v1.30.0-rc.0). Defaults to 'stable'.
