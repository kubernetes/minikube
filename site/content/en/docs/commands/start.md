...
```
      ...
      --base-image string                 The base image to use for docker/podman drivers. Intended for local development. (default "gcr.io/k8s-minikube/kicbase-builds:v0.0.37-1678988071-16068@sha256:57f4012deea6a123117f6ae1c93cff056cdb7d4e3b534ed0e03818b49099d014")
      ...
      --kubernetes-version string         The Kubernetes version that the minikube VM will use (ex: v1.2.3, 'stable' for v1.26.3, 'latest' for v1.27.0-beta.0). Defaults to 'stable'.
