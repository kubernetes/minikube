...
```
      ...
      --iso-url strings                   Locations to fetch the minikube ISO from. (default [https://storage.googleapis.com/minikube-builds/iso/minikube-v1.24.0-test-test-test3.iso,https://github.com/kubernetes/minikube/releases/download/v1.24.0-test-test-test3/minikube-v1.24.0-test-test-test3.iso,https://kubernetes.oss-cn-hangzhou.aliyuncs.com/minikube/iso/minikube-v1.24.0-test-test-test3.iso])
