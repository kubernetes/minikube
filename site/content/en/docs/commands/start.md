...
```
  ...
  -h, --help                              help for start
      ...
      --kubernetes-version string         The Kubernetes version that the minikube VM will use (ex: v1.2.3, 'stable' for v1.19.0-rc.4, 'latest' for v1.19.0-rc.4). Defaults to 'stable'.
