...
```
      ...
      --kubernetes-version string         The Kubernetes version that the minikube VM will use (ex: v1.2.3, 'stable' for v1.23.5, 'latest' for v1.24.0-beta.0). Defaults to 'stable'.
