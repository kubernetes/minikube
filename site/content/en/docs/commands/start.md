...
```
      ...
      --base-image string                 The base image to use for docker/podman drivers. Intended for local development. (default "gcr.io/k8s-minikube/kicbase-builds:v0.0.42-1700820446-17662@sha256:396b0566b8b7add99826e3775371ce1c6c50437ca0f3c1b8da079a25d3e47890")
  ...
  -g, --gpus string                       Allow pods to use your NVIDIA GPUs. Options include: [all,nvidia] (Docker driver with Docker container-runtime only)
      ...
      --kubernetes-version string         The Kubernetes version that the minikube VM will use (ex: v1.2.3, 'stable' for v1.28.4, 'latest' for v1.28.4). Defaults to 'stable'.
