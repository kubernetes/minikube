...
```
      ...
      --base-image string                 The base image to use for docker/podman drivers. Intended for local development. (default "gcr.io/k8s-minikube/kicbase-builds:v0.0.39-1685009248-16581@sha256:74ff9ec57bb6aefd79b7832fa85b312bbe8a5c7b22a5aafc55ac93a0150c329d")
      ...
      --kubernetes-version string         The Kubernetes version that the minikube VM will use (ex: v1.2.3, 'stable' for v1.27.2, 'latest' for v1.27.2). Defaults to 'stable'.
