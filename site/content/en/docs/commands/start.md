...
```
      ...
      --base-image string                 The base image to use for docker/podman drivers. Intended for local development. (default "gcr.io/k8s-minikube/kicbase-builds:v0.0.25-1627498335-12030@sha256:e08509050780c491425dd707262cf5b50d3ab99a43aabccaf878c3a08967d353")
      ...
      --kubernetes-version string         The Kubernetes version that the minikube VM will use (ex: v1.2.3, 'stable' for v1.21.3, 'latest' for v1.22.0-beta.2). Defaults to 'stable'.
