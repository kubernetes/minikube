...
```
      ...
      --base-image string                 The base image to use for docker/podman drivers. Intended for local development. (default "gcr.io/k8s-minikube/kicbase-builds:v0.0.50-1784364224-23379@sha256:bf991f5a6b3f7afeb5a3c3768b11ae35740ee1c528d3de6ae03a04795ac92ee8")
  ...
  -d, --driver string                     Used to specify the driver to run Kubernetes in. The list of available drivers depends on operating system.
      ...
      --extra-disks int                   Number of extra disks created and attached to the minikube VM (currently only implemented for kvm2, qemu2, vfkit, and krunkit drivers)
  ...
  -g, --gpus string                       Allow pods to use your GPUs. Options include: [all,nvidia,amd] (Docker driver with Docker container-runtime only)
      ...
      --kubernetes-version string         The Kubernetes version that the minikube VM will use (ex: v1.2.3, 'stable' for v1.36.2, 'latest' for v1.36.2). Defaults to 'stable'.
