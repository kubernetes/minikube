...
```
      ...
      --base-image string                 The base image to use for docker/podman drivers. Intended for local development. (default "gcr.io/k8s-minikube/kicbase-builds:v0.0.42-1710929242-18458@sha256:fc8432ee37d76c53bb92e4720a1b9f39aecf261b31935446e786bfc5833ac2a5")
  ...
  -g, --gpus string                       Allow pods to use your NVIDIA GPUs. Options include: [all,nvidia] (Docker driver with Docker container-runtime only)
      ...
      --kubernetes-version string         The Kubernetes version that the minikube VM will use (ex: v1.2.3, 'stable' for v1.29.3, 'latest' for v1.30.0-beta.0). Defaults to 'stable'.
