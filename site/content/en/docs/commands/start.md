...
```
      ...
      --base-image string                 The base image to use for docker/podman drivers. Intended for local development. (default "gcr.io/k8s-minikube/kicbase-builds:v0.0.40-1693304194-17152@sha256:67938fd32d4cfea1eb2425eeb35f00367fd2add823707c006456bbeb17928bc7")
