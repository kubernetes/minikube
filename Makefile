...
out/docker-machine-driver-hyperkit:
	@echo "out/docker-machine-driver-hyperkit skipped";
	@echo "hyperkit driver will not be built anymore, checkout this issue for more details https://github.com/kubernetes/minikube/issues/21940";
# ifeq ($(MINIKUBE_BUILD_IN_DOCKER),y)
