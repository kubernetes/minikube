...
type API interface {
	io.Closer
	NewHost(driverName, cruntimeName string, rawDriver []byte) (*host.Host, error)
...
func (api *Client) NewHost(driverName, cRuntime string, rawDriver []byte) (*host.Host, error) {
