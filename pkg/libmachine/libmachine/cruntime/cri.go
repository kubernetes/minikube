...
func crictlList(cr runner.Runner, root string, o ListContainersOptions) (*runner.RunResult, error) {
...
func listCRIContainers(cr runner.Runner, root string, o ListContainersOptions) ([]string, error) {
...
func pauseCRIContainers(cr runner.Runner, root string, ids []string) error {
...
func getCrictlPath(cr runner.Runner) string {
	cmd := "crictl"
...
func unpauseCRIContainers(cr runner.Runner, root string, ids []string) error {
	args := []string{"runc"}
	if root != "" {
		args = append(args, "--root", root)
	}
...
func killCRIContainers(cr runner.Runner, ids []string) error {
	if len(ids) == 0 {
		return nil
	}
...
func pullCRIImage(cr runner.Runner, name string) error {
...
func removeCRIImage(cr runner.Runner, name string) error {
...
func stopCRIContainers(cr runner.Runner, ids []string) error {
	if len(ids) == 0 {
		return nil
	}
...
func populateCRIConfig(cr runner.Runner, socket string) error {
...
func getCRIInfo(cr runner.Runner) (map[string]interface{}, error) {
...
func listCRIImages(cr runner.Runner) ([]ListImage, error) {
...
func criContainerLogCmd(cr runner.Runner, id string, len int, follow bool) string {
	crictl := getCrictlPath(cr)
