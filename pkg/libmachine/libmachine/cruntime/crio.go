...
func generateCRIOConfig(cr runner.Runner, imageRepository string, kv semver.Version, cgroupDriver string) error {
...
func enableIPForwarding(cr runner.Runner) error {
...
func crioImagesPreloaded(runner runner.Runner, images []string) bool {
