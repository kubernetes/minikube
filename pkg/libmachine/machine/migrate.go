...
func MigrateHost(h *Machine, data []byte) (*Machine, bool, error) {
	var (
	...
	globalStorePath := filepath.Dir(filepath.Dir(migratedHostMetadata.MachineOptions.AuthOptions.StorePath))
