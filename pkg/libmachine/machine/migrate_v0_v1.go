...
func MigrateHostV0ToHostV1(hostV0 *V0) *V1 {
	...
	hostV1.HostOptions.RuntimeOptions = &cruntime.Options{
		TLSVerify:  true,
...
func MigrateHostMetadataV0ToHostMetadataV1(m *MetadataV0) *Metadata {
	...
	hostMetadata.MachineOptions.RuntimeOptions = &cruntime.Options{}
	hostMetadata.MachineOptions.AuthOptions = &auth.Options{
