...
func TestIsAddonAlreadySet(t *testing.T) {
	...
	if err := Set(cc, "registry", "true", &run.Options{}); err != nil {
...
func TestDisableUnknownAddon(t *testing.T) {
	...
	if err := Set(cc, "InvalidAddon", "false", &run.Options{}); err == nil {
...
func TestEnableUnknownAddon(t *testing.T) {
	...
	if err := Set(cc, "InvalidAddon", "true", &run.Options{}); err == nil {
...
func TestSetAndSave(t *testing.T) {
	...
	// enable
	if err := SetAndSave(profile, "dashboard", "true", &run.Options{}); err != nil {
	...
	// disable
	if err := SetAndSave(profile, "dashboard", "false", &run.Options{}); err != nil {
		t.Errorf("Disable returned unexpected error: %v", err)
	}
...
func TestStartWithAllAddonsDisabled(t *testing.T) {
	...
	UpdateConfigToDisable(cc, &run.Options{})
