...
func isRuntimeContainerd(cc *config.ClusterConfig, _, _ string, _ *run.Options) error {
...
func isVolumesnapshotsEnabled(cc *config.ClusterConfig, _, value string, _ *run.Options) error {
...
func isKVMDriverForNVIDIA(cc *config.ClusterConfig, name, _ string, _ *run.Options) error {
