...
func MaybePrintUpdateTextFromGithub(options *run.Options) {
...
func MaybePrintUpdateTextFromAliyunMirror(options *run.Options) {
	maybePrintUpdateText(GithubMinikubeReleasesAliyunURL, GithubMinikubeBetaReleasesAliyunURL, lastUpdateCheckFilePath, options)
}

func maybePrintUpdateText(latestReleasesURL string, betaReleasesURL string, lastUpdatePath string, options *run.Options) {
...
func maybePrintBetaUpdateText(betaReleasesURL string, localVersion semver.Version, latestFullVersion semver.Version, lastUpdatePath string, options *run.Options) bool {
...
func shouldCheckURLVersion(filePath string, options *run.Options) bool {
...
func shouldCheckURLBetaVersion(filePath string, options *run.Options) bool {
