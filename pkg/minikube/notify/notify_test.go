...
func TestShouldCheckURLVersion(t *testing.T) {
	...
	if shouldCheckURLVersion(lastUpdateCheckFilePath, run.Options{}) {
...
func TestShouldCheckURLBetaVersion(t *testing.T) {
	...
	if shouldCheckURLBetaVersion(lastUpdateCheckFilePath, run.Options{}) {
...
func TestMaybePrintUpdateText(t *testing.T) {
	...
	for _, tt := range tc {
		t.Run(tt.description, func(t *testing.T) {
			...
			maybePrintUpdateText(tt.latestFullVersionFromURL, tt.latestBetaVersionFromURL, tmpfile.Name(), run.Options{})
