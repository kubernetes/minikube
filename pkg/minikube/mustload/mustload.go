...
func Partial(name string, options *run.Options, miniHome ...string) (libmachine.API, *config.ClusterConfig) {
...
func Running(name string, options *run.Options) ClusterController {
...
func running(name string, first bool, options *run.Options) []ClusterController {
...
func Healthy(name string, options *run.Options) ClusterController {
