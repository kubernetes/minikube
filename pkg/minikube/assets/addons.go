...
var Addons = map[string]*Addon{
	...
	"ingress": NewAddon([]*BinAsset{
		...
		"IngressController": "ingress-nginx/controller:v1.9.4@sha256:5b161f051d017e55d358435f295f5e9a297e66158f136321d9b04520ec6c48a3",
	...
	"kong": NewAddon([]*BinAsset{
		...
		"Kong":        "kong:3.5.0@sha256:e8d0c74da65ba6b624203f8f825ba19be0ce2fa233324153c65182f6add22c8e",
	...
	"registry": NewAddon([]*BinAsset{
		...
		"Registry":          "registry:3.0.0-alpha.1@sha256:2c817f7e2ebe2a57e44278f51bbb8dd5e17b3494a6844bc14e7ea1dfec70c249",
	...
	"nvidia-device-plugin": NewAddon([]*BinAsset{
		...
		map[string]string{
			"NvidiaDevicePlugin": "nvidia/k8s-device-plugin:v0.14.3@sha256:339be23400f58c04f09b6ba1d4d2e0e7120648f2b114880513685b22093311f1",
		}, map[string]string{
