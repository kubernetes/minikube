...
var Addons = map[string]*Addon{
	...
	"inspektor-gadget": NewAddon([]*BinAsset{
		...
		map[string]string{
			"InspektorGadget": "inspektor-gadget/inspektor-gadget:v0.26.0@sha256:c6db0381372939368364efb98d8c90f4b0e3d86a5637682b85a01195937d9eff",
		}, map[string]string{
	...
	"kong": NewAddon([]*BinAsset{
		...
		"Kong":        "kong:3.6.1@sha256:ea92ee61b0a70171a8ded9e8c96be56ca3325847ac32cf32f61964b58acb8166",
		"KongIngress": "kong/kubernetes-ingress-controller:3.1.2@sha256:a9293ca8103ac456180cefdda2a2f7942e7cc2474b1cc0b73ac158b10c4bded6",
	}, map[string]string{
		"Kong":        "docker.io",
	...
	"kubevirt": NewAddon([]*BinAsset{
		...
		"Kubectl": "bitnami/kubectl:1.29.3@sha256:e15084c9093e4c840ebb6e91a23cfbeeaac6a6450ce15ee92d7ee322d9b4f7af",
	}, map[string]string{
		"Kubectl": "docker.io",
	}),
	...
	"headlamp": NewAddon([]*BinAsset{
		...
		map[string]string{
			"Headlamp": "headlamp-k8s/headlamp:v0.23.0@sha256:94e00732e1b43057a9135dafc7483781aea4a73a26cec449ed19f4d8794308d5",
		},
		map[string]string{
			"Headlamp": "ghcr.io",
		}),
