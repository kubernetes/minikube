...
var Addons = map[string]*Addon{
	...
	"inspektor-gadget": NewAddon([]*BinAsset{
		...
		map[string]string{
			"InspektorGadget": "inspektor-gadget/inspektor-gadget:v0.51.1@sha256:a21dff4c1e9e61d58073195e4badf3ec230b9fa8ff0db6436825774e81a542ec",
		}, map[string]string{
	...
	"nvidia-device-plugin": NewAddon([]*BinAsset{
		...
		map[string]string{
			"NvidiaDevicePlugin": "nvidia/k8s-device-plugin:v0.19.1@sha256:5f19f1a3907a36401318219b1173c4e0e92ab3ef928219c40773bd5f898dc81f",
		}, map[string]string{
	...
	"nrc": NewAddon([]*BinAsset{
		...
		MustBinAsset(addons.NrcAssets, "nrc/nrc.yaml", vmpath.GuestAddonsDir, "nrc.yaml", "0640"),
	}, false, "nrc", "node-readiness-controller (SIGs)", "", "https://node-readiness-controller.sigs.k8s.io/", nil, nil, nil),
}
