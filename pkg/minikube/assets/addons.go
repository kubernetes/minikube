...
var Addons = map[string]*Addon{
	...
	"kong": NewAddon([]*BinAsset{
		...
		"KongIngress": "kong/kubernetes-ingress-controller:3.2.1@sha256:9779e48ea34ed57ec9bb985430adeb326b63048cb669b12ff1cd9bbe6e511214",
	}, map[string]string{
		"Kong":        "docker.io",
	...
	"kubevirt": NewAddon([]*BinAsset{
		...
		"Kubectl": "bitnami/kubectl:1.30.2@sha256:3f6d4783cf84b56cb5aa33d0b404b5270aafaa6dcd5afe844b3cd55558383fa2",
	}, map[string]string{
		"Kubectl": "docker.io",
	}),
