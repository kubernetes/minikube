...
var Addons = map[string]*Addon{
	...
	"inspektor-gadget": NewAddon([]*BinAsset{
		...
		map[string]string{
			"InspektorGadget": "inspektor-gadget/inspektor-gadget:v0.19.0@sha256:900ee9d94e12c15caebf0f198a51b532e6e2e373f6adfdef6fc78d11f6ecc6ac",
		}, map[string]string{
	...
	"cloud-spanner": NewAddon([]*BinAsset{
		...
		"CloudSpanner": "cloud-spanner-emulator/emulator:1.5.7@sha256:79c79804e8dcc89a9f70e08c362340fcc0f1a15828fdb147e8ae42936d1c0455",
	}, map[string]string{
		"CloudSpanner": "gcr.io",
	}),
}
