...
func NewAPIClient(options *run.Options, miniHome ...string) (libmachine.API, error) {
...
func StartDriver(options *run.Options) {
...
func registerDriver(drvName string, options *run.Options) {
	def := registry.Driver(drvName)
	if def.Empty() {
