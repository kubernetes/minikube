	...
	tests := []struct {
	...
	}{
		{
			def: registry.DriverDef{
				...
				Status:   func(_ run.Options) registry.State { return registry.State{Installed: true, Healthy: false} },
			},
		...
		},
		{
			def: registry.DriverDef{
				...
				Status:   func(_ run.Options) registry.State { return registry.State{Installed: true, Healthy: true} },
			},
