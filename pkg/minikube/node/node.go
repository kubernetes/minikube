...
func teardown(cc config.ClusterConfig, name string, options *run.Options) (*config.Node, error) {
...
func Delete(cc config.ClusterConfig, name string, options *run.Options) (*config.Node, error) {
