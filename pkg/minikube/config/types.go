...
type ClusterConfig struct {
	...
	CustomAddonImages       map[string]string // Maps image names to the image to use for addons. e.g. Dashboard -> polyverse/node-echo-server makes dashboard addon use echoserver for its Dashboard deployment.
