...
var ResourceErrors = map[string]match{
	"KVM_OOM": {
		...
		GOOS:     []string{"linux"},
		Issues:   []int{6366},
		ExitCode: exit.InsufficientMemory,
	},
	"OOM_KILL_SSH": {
...
`,
		Issues:   []int{9024},
		ExitCode: exit.InsufficientStorage,
	},
}	

var DockerInsufficientStorage = ResourceErrors["DOCKER_INSUFFICIENT_STORAGE"]
...
var ProviderErrors = map[string]match{
	...
	"HYPERKIT_NOT_FOUND": {
		...
		URL:      "https://minikube.sigs.k8s.io/docs/reference/drivers/hyperkit/",
		GOOS:     []string{"darwin"},
		ExitCode: exit.ProviderNotFound,
	},
	...
	"HYPERV_AS_ADMIN": {
		...
		Issues:   []int{4511},
		GOOS:     []string{"windows"},
		ExitCode: exit.ProviderPermission,
	},
	"HYPERV_NEEDS_ESC": {
	...
	"KVM_UNAVAILABLE": {
		...
		Issues:   []int{2991},
		GOOS:     []string{"linux"},
		ExitCode: exit.ProviderUnavailable,
	},
	...
	"KVM_ISO_PERMISSION": {
		...
		GOOS:     []string{"linux"},
		Issues:   []int{5950},
		ExitCode: exit.ProviderPermissions,
	},
	...
	"VBOX_DRV_NOT_LOADED": {
		...
		ExitCode: exit.ProviderNotRunning,
	},
	"VBOX_DEVICE_MISSING": {
	...
	"VBOX_HARDENING": {
		...
		GOOS:     []string{"windows"},
		ExitCode: exit.ProviderConflict,
	},
	"VBOX_NS_ERRROR": {
...
var DriverErrors = map[string]match{
	...
	"DRIVER_NOT_FOUND": {
		...
		Issues:   []int{5295},
		ExitCode: exit.DriverUnsupported,
	},
	...
	"HYPERV_POWERSHELL_NOT_FOUND": {
		...
		URL:      "https://docs.docker.com/machine/drivers/hyper-v/",
		GOOS:     []string{"windows"},
		ExitCode: exit.DriverUnavailable,
	},
...
var LocalNetworkErrors = map[string]match{
	"SSH_AUTH_FAILURE": {
		...
		URL:      vpnDoc,
		Issues:   []int{3930},
		ExitCode: exit.LocalNetworkConfig,
	},
	"SSH_TCP_FAILURE": {
	...
	"HOST_CIDR_CONFLICT": {
		...
		Issues:   []int{3594},
		ExitCode: exit.LocalNetworkConflict,
	},
	"VBOX_HOST_ADAPTER": {
		...
		ExitCode: exit.LocalNetworkNotFound,
	},
	"VBOX_IP_CONFLICT": {
	...
	"WAITING_FOR_SSH": {
		...
		Advice:   "Try 'minikube delete', and disable any conflicting VPN or firewall software",
		Issues:   []int{4617},
		ExitCode: exit.LocalNetworkTimeout,
	},
...
var InternetProblems = map[string]match{
	"GCR_UNAVAILABLE": {
		...
		URL:      proxyDoc,
		Issues:   []int{3860},
		ExitCode: exit.InternetUnavailable,
	},
	...
	"DOWNLOAD_TLS_OVERSIZED": {
		...
		ExitCode: exit.InternetConflict,
	},
	"DOWNLOAD_BLOCKED": {
	...
	"NONE_DEFAULT_ROUTE": {
		...
		GOOS:     []string{"linux"},
		ExitCode: exit.InternetNotFound,
	},	
}
...
var RuntimeErrors = map[string]match{
	...
	"DOCKER_UNAVAILABLE": {
		...
		Issues:   []int{3952},
		ExitCode: exit.RuntimeUnavailable,
	},	
	"NONE_DOCKER_EXIT_1": {
...
var KubernetesErrors = map[string]match{
	...
	"APISERVER_TIMEOUT": {
		...
		URL:      vpnDoc,
		Issues:   []int{4302},
		ExitCode: exit.KubernetesTimeout,
	},
	"DNS_TIMEOUT": {
	...
	"SERVICE_NOT_FOUND": {
		...
		Issues:   []int{4599},
		ExitCode: exit.KubernetesNotFound,
	},
