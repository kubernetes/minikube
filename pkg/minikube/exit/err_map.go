...
// Program Issues are issues with the minikube binary
var ProgramIssues = []KnownIssue{
	{
		ID:       "INVALID_KUBERNETES_VERSION",
	...
	{
		ID:       "KUBERNETES_VERSION_MISSING_V",
...
var DockerInsufficientStorage = KnownIssue{
	ID:     "DOCKER_INSUFFICENT_STORAGE",
...
var HostIssues = []KnownIssue{
	{
		ID:       "VBOX_VTX_DISABLED",
	...
	},
	{
		...
		ExitCode: HostPermission,
	},
	{
		ID:       "KUBECONFIG_DENIED",
...
var ProviderIssues = []KnownIssue{
	...
	{
		ID:       "DOCKER_PROVISION_STUCK_CONTAINER",
	...
	},
	{
		...
		ExitCode: ProviderNotRunning,
	},
	{
		ID:       "VBOX_DEVICE_MISSING",
...
var DriverIssues = []KnownIssue{
	...
	},
	{
		...
		Issues:   []int{5295},
		ExitCode: DriverUnsupported,
	},
	{
		ID:               "DRIVER_MISSING_ADDRESS",
	...
	// Hyper-V
	{
		...
		GOOS:     []string{"windows"},
		ExitCode: DriverConfig,
	},
	{
		ID:       "HYPERV_VSWITCH_NOT_FOUND",
		...
		URL:      "https://docs.docker.com/machine/drivers/hyper-v/",
		GOOS:     []string{"windows"},
		ExitCode: DriverUsage,
	},
	{
		ID:       "HYPERV_POWERSHELL_NOT_FOUND",
...
var LocalNetworkIssues = []KnownIssue{
	{
		ID:       "SSH_AUTH_FAILURE",
	...
	},
	{
		...
		Issues:   []int{3594},
		ExitCode: LocalNetworkConflict,
	},
	{
		ID:       "VBOX_HOST_ADAPTER",
	...
	},
	{
		...
		Advice:   "Try 'minikube delete', and disable any conflicting VPN or firewall software",
		Issues:   []int{4617},
		ExitCode: LocalNetworkTimeout,
	},
}

// InternetIssues are internet related problems.
var InternetIssues = []KnownIssue{
	{
		ID:       "GCR_UNAVAILABLE",
		...
		URL:      proxyDoc,
		Issues:   []int{3860},
		ExitCode: InternetUnavailable,
	},
	{
		ID:       "DOWNLOAD_RESET_BY_PEER",
	...
	{
		ID:       "DOWNLOAD_IO_TIMEOUT",
		Regexp:   re(`Error downloading .*timeout`),
		Advice:   "A firewall is likely blocking minikube from reaching the internet. You may need to configure minikube to use a proxy.",
		URL:      proxyDoc,
		Issues:   []int{3846},
		ExitCode: InternetTimeout,
	},
	{
		ID:       "DOWNLOAD_TLS_OVERSIZED",
	...
	},
	{
		...
		URL:      proxyDoc,
		ExitCode: InternetConfig,
	},
	{
		ID:       "HTTP_HTTPS_RESPONSE",
	...
	},
	{
		...
		GOOS:     []string{"linux"},
		ExitCode: InternetNotFound,
	},
}

var GuestIssues = []KnownIssue{
	{
		ID:       "KVM2_NO_DOMAIN",
	...
	},
	{
		...
		ExitCode: GuestNotRunning,
	},
	{
		ID:       "CERT_NOT_SIGNED_BY_CA",
...
var RuntimeIssues = []KnownIssue{
	{
		ID:       "DOCKER_RESTART_FAILED",
...
var ServiceIssues = []KnownIssue{
	{
		...
		Issues:   []int{4599},
		ExitCode: ServiceNotFound,
	},
	{
		ID:       "OPEN_SERVICE_NOT_FOUND",
