...
<img src="https://github.com/kubernetes/minikube/raw/master/images/logo/logo.png" width="100" alt="The Minikube project logo">
...
<img src="https://raw.githubusercontent.com/kubernetes/minikube/master/site/static/images/screenshot.png" width="575" height="322" alt="Screenshot of Minikube in action">
...
📣 **Please fill out our [fast 5-question survey](https://forms.gle/Gg3hG5ZySw8c1C24A)** so that we can learn how and why you use minikube, and what improvements we should make. Thank you! 🎉
...
See Minikube in action with detailed examples and use cases [here](https://minikube.sigs.k8s.io/docs/handbook/controls/).

## Governance

The Minikube project is part of the Kubernetes ecosystem and is governed by the Kubernetes project's principles, values, policies, and processes.

The [Kubernetes Community](https://github.com/kubernetes/community/blob/master/governance.md) is the starting point for learning about how the Kubernetes ecosystem is organized.
